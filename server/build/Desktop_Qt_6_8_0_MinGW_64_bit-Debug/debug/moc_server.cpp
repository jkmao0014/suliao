...
constexpr auto qt_meta_stringdata_CLASSServerENDCLASS = QtMocHelpers::stringData(
    "Server",
    "on_whichtable_currentIndexChanged",
    "",
    "index",
    "on_sqlsubmit_clicked",
    "onNewConnection",
    "on_listen_clicked",
...
Q_CONSTINIT const QMetaObject Server::staticMetaObject = { {
    ...
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSServerENDCLASS_t,
        ...
        // method 'on_whichtable_currentIndexChanged'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        QtPrivate::TypeAndForceComplete<int, std::false_type>,
        // method 'on_sqlsubmit_clicked'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'onNewConnection'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'on_listen_clicked'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
...
void Server::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->on_whichtable_currentIndexChanged((*reinterpret_cast< std::add_pointer_t<int>>(_a[1]))); break;
        case 1: _t->on_sqlsubmit_clicked(); break;
        case 2: _t->onNewConnection(); break;
        case 3: _t->on_listen_clicked(); break;
